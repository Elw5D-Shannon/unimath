1设 n 阶矩阵 $A=[a_{ij}]_{n\times n}$，则二次型 $f(x_1,x_2,\cdots,x_n)=\sum\limits_{i=1}^{n}(a_{i1}x_1+a_{i2}x_2+\cdots+a_{in}x_n)^2$ 的矩阵为$\underline{\qquad}$。
...
2.设实二次型 $f(x_1,x_2,x_3)=x_1^2+x_2^2+x_3^2-2x_1x_2-2x_1x_3+2ax_2x_3$ 通过正交变换可化为
标准型 $f=2y_1^2+2y_2^2+by_3^2$。
...
3.已知实二次型
$f(x_1,x_2,x_3)=2x_1^2+x_2^2-4x_1x_2+2ax_2x_3\quad (a\ge 0)$
通过正交变换$\boldsymbol{x}=\boldsymbol{Q}\boldsymbol{y}$可化为标准形$y_1^2-2y_2^2+4y_3^2$。
